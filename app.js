...
function initThemeSelector() {
  ...
  const THEME_MAP = {
    default: {
      ...
      '--border-light': 'rgba(15, 61, 59, 0.12)',
      '--color-text': '#0E1A19',
      ...
      '--bg-gradient': 'linear-gradient(135deg, #FAF9F5 0%, #F0EDE6 100%)'
    },
    usa: {
      '--bg-primary': '#E6EEF8',
      '--bg-secondary': '#D5E3F5',
      '--bg-glass': 'rgba(255, 255, 255, 0.75)',
      '--border-glass': 'rgba(255, 255, 255, 0.9)',
      '--border-light': 'rgba(10, 30, 60, 0.12)',
      '--color-text': '#0A1C36',
      ...
      '--color-accent-green': '#0A1C36',
      '--bg-gradient': 'linear-gradient(135deg, #E6EEF8 0%, #FDF3F5 50%, #F5D5DC 100%)'
    },
    india: {
      '--bg-primary': '#FFF4E8',
      '--bg-secondary': '#FFE5CC',
      '--bg-glass': 'rgba(255, 255, 255, 0.75)',
      '--border-glass': 'rgba(255, 255, 255, 0.9)',
      '--border-light': 'rgba(14, 53, 36, 0.12)',
      '--color-text': '#0E3524',
      '--color-text-secondary': '#2E4D3E',
      '--color-accent-gold': '#E67E22',
      '--color-accent-gold-hover': '#C35E0B',
      '--color-accent-orange': '#E67E22',
      '--color-accent-red': '#C52A2A',
      '--color-accent-green': '#138808',
      '--bg-gradient': 'linear-gradient(135deg, #FFF0E0 0%, #FFFFFF 50%, #E6F5EC 100%)'
    },
    pakistan: {
      '--bg-primary': '#E6F5EC',
      '--bg-secondary': '#C8ECDA',
      '--bg-glass': 'rgba(255, 255, 255, 0.75)',
      '--border-glass': 'rgba(255, 255, 255, 0.9)',
      '--border-light': 'rgba(6, 38, 21, 0.12)',
      '--color-text': '#062615',
      '--color-text-secondary': '#274D3A',
      '--color-accent-gold': '#C5A028',
      '--color-accent-gold-hover': '#AA8717',
      '--color-accent-orange': '#10663C',
      '--color-accent-red': '#A82424',
      '--color-accent-green': '#10663C',
      '--bg-gradient': 'linear-gradient(135deg, #E6F5EC 0%, #FFFFFF 50%, #C8ECDA 100%)'
    },
    uk: {
      '--bg-primary': '#EBF0F8',
      '--bg-secondary': '#D5E0F2',
      '--bg-glass': 'rgba(255, 255, 255, 0.75)',
      '--border-glass': 'rgba(255, 255, 255, 0.9)',
      '--border-light': 'rgba(11, 25, 56, 0.12)',
      '--color-text': '#0B1938',
      ...
      '--bg-gradient': 'linear-gradient(135deg, #EBF0F8 0%, #FFF5F6 50%, #F5D5D9 100%)'
    },
    japan: {
      '--bg-primary': '#FFF0F2',
      '--bg-secondary': '#FFE0E5',
      '--bg-glass': 'rgba(255, 255, 255, 0.75)',
      '--border-glass': 'rgba(255, 255, 255, 0.9)',
      '--border-light': 'rgba(42, 16, 21, 0.12)',
      '--color-text': '#2A1015',
      ...
      '--bg-gradient': 'linear-gradient(135deg, #FFF0F2 0%, #FFFFFF 50%, #FFE0E5 100%)'
    }
  };
